...
const Panels = () => {
  ...
  return (
    <>
      <>
        {menuPanel.visible && <MenuPanel></MenuPanel>}
        <AnimatePresence>
          ...
          <motion.div name="modal">{modals.addToPlaylist && <AddToPlaylist playlists={playlists.listing}></AddToPlaylist>}</motion.div>
          ...
          <motion.div name="modal">{modals.castMenu && <castmenu></castmenu>}</motion.div>
          <motion.div name="modal">{modals.pathMenu && <pathmenu></pathmenu>}</motion.div>
          <motion.div name="modal">{modals.airplayPW && <airplay-modal></airplay-modal>}</motion.div>
          <motion.div name="modal">{modals.pluginMenu && <PluginMenu></PluginMenu>}</motion.div>
          <motion.div name="modal">{modals.settings && <SettingsWindow></SettingsWindow>}</motion.div>
          <motion.div name="modal">{modals.equalizer && <EQView></EQView>}</motion.div>
          <motion.div name="modal">
            {modals.qrcode && (
              <QRCodeModal
                src="webremoteqr"
                url="webremoteurl"></QRCodeModal>
            )}
          </motion.div>
          <motion.div name="modal">{modals.moreInfo && <MoreInfoModal data="moreinfodata"></MoreInfoModal>}</motion.div>
        </AnimatePresence>
        <div
