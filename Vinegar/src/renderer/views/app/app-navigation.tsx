    ...
    <>
      <div
        ...
        <AnimatePresence>
          ...
          <motion.div name="sidebartransition">{!chrome.sidebarCollapsed && <Sidebar></Sidebar>}</motion.div>
          <AppContentArea></AppContentArea>
          <motion.div name="drawertransition">
            {drawer.open && drawer.panel === "lyrics" && lyrics && lyrics !== [] && lyrics.length > 0 && (
              <div className="app-drawer">
                <div className="bgArtworkMaterial">
                  <div className="bg-artwork-container">
                    {cfg.visual.bg_artwork_rotation && animateBackground && (
                      <img
          ...
          <motion.div name="drawertransition">{drawer.open && drawer.panel === "queue" && <div className="app-drawer">{drawer.panel === "queue" && <Queue ref="queue"></Queue>}</div>}</motion.div>
        </AnimatePresence>
      </div>
    </>
  );
