        ...
        <div id="app-sidebar">
                        ...
                        <template>
                          {$root.search.hints
                            ...
                            .map((item, position) => (
                              <MediaItemSmarthints
                                item={item.content}
                                position={position}></MediaItemSmarthints>
                            ))}
                        </template>
                      </div>
                    </div>
          ...
          <div
              ...
              <template>
                {$root.cfg.general.sidebarItems.recentlyAdded && (
                  <SidebarLibraryItem
                    ...
                    page="library-recentlyadded"></SidebarLibraryItem>
                )}
                {$root.cfg.general.sidebarItems.songs && (
                  <SidebarLibraryItem
                    ...
                    svg-icon-name="songs"
                    page="library-songs"></SidebarLibraryItem>
                )}
                {$root.cfg.general.sidebarItems.albums && (
                  <SidebarLibraryItem
                    ...
                    page="library-albums"></SidebarLibraryItem>
                )}
                {$root.cfg.general.sidebarItems.artists && (
                  <SidebarLibraryItem
                    ...
                    page="library-artists"></SidebarLibraryItem>
                )}
                {$root.cfg.general.sidebarItems.videos && (
                  <SidebarLibraryItem
                    ...
                    page="library-videos"></SidebarLibraryItem>
                )}
                {$root.cfg.general.sidebarItems.podcasts && (
                  <SidebarLibraryItem
                    ...
                    page="podcasts"></SidebarLibraryItem>
                )}
              </template>
            )}
            {/*{($root.cfg.libraryPrefs.localPaths.length !== 0) && <template><div className="app-sidebar-header-text"
                    ...
                    <SidebarPlaylist item={{attributes: { name:'Songs'} , id:'ciderlocal'}} ></SidebarPlaylist>
                </template>}</template>}*/}
            ...
            {!$root.cfg.general.sidebarCollapsed.playlists && (
              <template>
                <button
                  ...
                  <SVGIcon url="./assets/feather/plus.svg"></SVGIcon>
                ...
                <div className="input-container">
                  ...
                  {typeof $root.mk.volume !== "undefined" && (
                    <input
                      ...
                      v-b-tooltiphover
                      title={$root.formatVolumeTooltip()}></input>
                  )}
                </div>
              </div>
            </div>
