                    ...
                    {devices.airplay.map((device) => (
                      <div key={device.id}>
                        <div
                          ...
                          {activeCasts.some((item) => item.host === device.host && item.name === device.name && item.port === device.port) ? (
                            <div
                              className={"md-option-segment_auto"}
                              style={{ display: "flex", justifyContent: "center", alignItems: "center" }}
