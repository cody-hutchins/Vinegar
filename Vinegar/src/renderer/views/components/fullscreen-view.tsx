              ...
              <div className="bg-artwork-container">
                {app.cfg.visual.bg_artwork_rotation && app.animateBackground && (
                  <img
                    ...
                    src={(image ?? "").replace("{w}", "30").replace("{h}", "30")}></img>
                )}
                {app.cfg.visual.bg_artwork_rotation && app.animateBackground && (
                  <img
              ...
              <div className="col artwork-col">
                <div
                  ...
                  <MediaItemArtwork
                    ...
                    video="video"
                    videoPriority="true"
                    url={(image ?? "").replace("{w}", "600").replace("{h}", "600")}></MediaItemArtwork>
                </div>
                {app.mkReady() && (
